<%@ Page Title="" Language="C#" MasterPageFile="~/AddFollowUpMaster.master" AutoEventWireup="true" CodeFile="AddFuProcedureDetails.aspx.cs" Inherits="AddFuProcedureDetails" %>
  ...
  z-index: -1;
    ...
    <div class="form-horizontal">
        ...
        <div class="span9 patientDetails">
            ...
            <div class="form-horizontal">
                 <div class="span6">MA and Providers : 
        ...
        <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        <div class="span12">
                                    <div class="form-horizontal">
                                        <div class="span3"><label >BodyPart :</label></div>
                                        <div class="span9">
                                            ...
                                            <asp:DropDownList ID="ddBodyPart" runat="server" Enabled="false"></asp:DropDownList></div>
                                    </div>
                                    <div class="form-horizontal">
                                        <div class="span3">Type :</div>
                                        <div class="span9">
                                            <asp:RadioButtonList ID="rblDateType" Enabled="false" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rblDateType_SelectedIndexChanged">
                                   ...
                                   <div class="form-horizontal">
                                        ...
                                        <div class="span9">
                                            ...
                                            <asp:DropDownList ID="ddProcedure" CssClass="form-control" runat="server" Enabled="false"></asp:DropDownList></div>
                                    </div>
                                    <div class="form-horizontal">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="span9">
                                            <asp:TextBox ID="txtDate" CssClass="dateonly" ReadOnly="true" runat="server"></asp:TextBox></div>
                                    </div> 
                                <div class="form-horizontal">
                                     <div class="span3"></div>
                                    <div class="span9">
