                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-9" style="margin-top: 5px">
                           <table style="width: 100%">
                            ...
                            <editable:EditableDropDownList runat="server" ID="ddlLevels" Width="257px" CssClass="inline">
                            </editable:EditableDropDownList>
                            <br />
                            <asp:Label Style="float: left;" runat="server" Text="The Spurling test is &nbsp;" Font-Bold="False"></asp:Label>
                            <editable:EditableDropDownList runat="server" ID="cboSpurlings" Width="257px" CssClass="inline">
                            </editable:EditableDropDownList>
                            <asp:Label Style="float: left;" runat="server" Text="&nbsp;. The cervical distraction test is &nbsp;" Font-Bold="False"></asp:Label>
                            <editable:EditableDropDownList runat="server" ID="cboDistraction" Width="257px" CssClass="inline">
                            </editable:EditableDropDownList>--%>
                        </div>
                    </div>
