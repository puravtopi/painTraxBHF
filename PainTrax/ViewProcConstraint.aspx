<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewProcConstraint.aspx.cs" MasterPageFile="~/site.master" Inherits="ViewProcConstraint" %>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:Button runat="server" ID="btnAdd" Text="Add New" CssClass="btn btn-primary" PostBackUrl="~/AddProConstraint.aspx" />
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvPatientDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="pager">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Procedures" HeaderText="Proc Req/Sched" />
                                        <asp:BoundField DataField="PreRequest" HeaderText="Proced Executed" />
