...
public partial class Page2 : System.Web.UI.Page
{
    ...
    protected void chk_r_Shoulder_CheckedChanged(object sender, EventArgs e)
    {
        ...
        //if (chk_r_Shoulder.Checked == true && chk_L_Shoulder.Checked == true)
        //    saveSideIE("shoulder", "b", false, false);
        //else if (chk_r_Shoulder.Checked == true)
        //    saveSideIE("shoulder", "r", false, false);
    ...
    protected void chk_L_Shoulder_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (chk_r_Shoulder.Checked == true && chk_L_Shoulder.Checked == true)
            saveSideIE("shoulder", "b", false, false);
        else if (chk_L_Shoulder.Checked == true)
            saveSideIE("shoulder", "l", false, false);
    ...
    private void saveSideIE(string bodyPart, string side, bool isDelete, bool otherBody)
    {
        try
        {
            ...
            if (!isDelete)
            {
                ...
                divCC.InnerHtml = ccbody;
                divPE.InnerHtml = pebody;

                ClientScript.RegisterStartupScript(this.GetType(), "sideFun122", "bindCCPE('" + side + "');", true);
    ...
    {
        string ccbody = hdCC.Value;
        string pebody = hdPE.Value;
    }
}
