...
public partial class ViewProcedure : System.Web.UI.Page
{
    ILog log = log4net.LogManager.GetLogger(typeof(ViewProcedure));
    ...
    public DataSet bindInsCoDetails(int pageIndex = 1, string sortorder = "asc", string columnname = "Procedure_ID")
    {
        DataSet lds = null;
        int totalrecords = 0;
        ...
        using (SqlConnection gConn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_V3"].ConnectionString))
        {
            try
            {
                ...
                SqlCommand gComm = new SqlCommand("nusp_GetProcedure_paging", gConn);
                ...
                if (totalrecords > 0)
                {
                    gvProcedureDetails.DataSource = lds;
                    gvProcedureDetails.DataBind();
                }
                else
                {
                    gvProcedureDetails.DataSource = null;
                    gvProcedureDetails.DataBind();
                }
