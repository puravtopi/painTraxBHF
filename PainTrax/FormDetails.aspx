<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="FormDetails.aspx.cs" Inherits="FormDetails" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpMain" Runat="Server">
    ...
    <style>
        ...
        Search By Name: <asp:TextBox runat="server" ID="txt_name" OnTextChanged="txt_name_TextChanged" AutoPostBack="true"></asp:TextBox>&nbsp;<button class="btn" type="button">Search</button>     
