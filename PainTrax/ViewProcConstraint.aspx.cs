...
public partial class ViewProcConstraint : System.Web.UI.Page
{
    ILog log = log4net.LogManager.GetLogger(typeof(ViewProcConstraint));
    ...
    public DataSet bindData(int pageIndex = 1, string sortorder = "asc", string columnname = "Id")
    {
        DataSet lds = null;
        int totalrecords = 0;
        ...
        using (SqlConnection gConn = new SqlConnection(ConfigurationManager.ConnectionStrings["connString_V3"].ConnectionString))
        {
            try
            {
                ...
                SqlCommand gComm = new SqlCommand("nusp_GetProcConstraint_paging", gConn);
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string SP = "nusp_ProConstraint_delete";
            SqlParameter[] param = new SqlParameter[1];



            param[0] = new SqlParameter("@Id", lnkdelete.CommandArgument);
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            cnd = " where BodyPart like '%" + txtSearch.Text + "%' or Procedures like '%" + txtSearch.Text + "%' or PreRequest like '%" + txtSearch.Text + "%'";
        }
