<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="ViewDiagCodes.aspx.cs" Inherits="ViewDiagCodes" %>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:Button runat="server" ID="btnAdd" Text="Add New" CssClass="btn btn-primary" PostBackUrl="~/AddDiagCode.aspx" />
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <asp:GridView ID="gvDiagCodeDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="pager">
                                    <Columns>

                                        <asp:BoundField DataField="BodyPart" HeaderText="Body Part" />
                                        <asp:BoundField DataField="DiagCode" HeaderText="DiagCode" />
                                        <asp:BoundField DataField="Description" HeaderText="Description" />

                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server" CssClass="btn btn-link" ID="hlEdit" Target="_blank" NavigateUrl='<%# "~/AddDiagCode.aspx?id="+Eval("DiagCode_ID") %>' Text="Edit"></asp:HyperLink>
                                                <asp:LinkButton runat="server" ID="lnkDelete" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?')" CausesValidation="false" OnClick="lnkDelete_Click" CommandArgument='<%# Eval("DiagCode_ID") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
