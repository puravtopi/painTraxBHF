<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="AddPharmacy.aspx.cs" Inherits="AddPharmacy" %>
            ...
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-sm-2">
                                <label class="lblstyle">Pharmacy</label>
                            </div>
                            <div class="col-sm-9">
                                <asp:TextBox ID="txtPharmacy" CssClass="form-control" placeholder="Pharmacy" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPharmacy" Display="Dynamic" ErrorMessage="Please enter pharmacy." SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    &nbsp;
                                                <asp:Button ID="btnBack" PostBackUrl="~/ViewPharmacy.aspx" CausesValidation="false" runat="server" CssClass="btn btn-default" Text="Back" />
                                </div>
                            </div>
