...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <ContentTemplate>
                        <div class="row">
                            ...
                            <div class="col-md-9" style="margin-top: 5px">
                                ...
                                <asp:GridView ID="dgvMedi" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover">
                                    <Columns>
                                        <%-- <asp:TemplateField>
                                    <ItemTemplate>
    ...
    <div class="modal fade" id="DiagPopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none; width: 950px; margin-right: 20%">
        <div class="modal-dialog" style="width: 950px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:UpdatePanel runat="server" ID="upMedice" UpdateMode="Conditional">
                        <ContentTemplate>
