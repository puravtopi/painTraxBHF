<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="AddAttorney.aspx.cs" Inherits="AddAttorney" %>
                ...
                <div class="col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="col-sm-2">
                                    <label class="lblstyle">Attorney</label>
                                </div>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtAttorny" CssClass="form-control" placeholder="Attorney" runat="server"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAttorny" Display="Dynamic" ErrorMessage="Please enter attorney." SetFocusOnError="True"></asp:RequiredFieldValidator>
                                </div>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <asp:RegularExpressionValidator runat="server" ID="regEmail" ErrorMessage="Invalid Email" ControlToValidate="txtEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic" SetFocusOnError="true"></asp:RegularExpressionValidator>
                                </div>
                            </div>
