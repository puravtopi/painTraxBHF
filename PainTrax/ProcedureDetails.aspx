<%@ Page Language="C#" MasterPageFile="~/PageMainMaster.master" AutoEventWireup="true" CodeFile="ProcedureDetails.aspx.cs" Inherits="ProcedureDetails" %>
                                ...
                                <div class="span12">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="span9">
                                            ...
                                            <asp:RadioButtonList ID="rblDateType" runat="server" Enabled="false">
                                                <asp:ListItem Value="R">Requested</asp:ListItem>
                                                <asp:ListItem Value="S">Scheduled</asp:ListItem>
                                                <asp:ListItem Value="E">Executed</asp:ListItem>
                                            </asp:RadioButtonList>
