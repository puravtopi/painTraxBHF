<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddFuDrugs.aspx.cs" Inherits="AddFuDrugs" %>
    ...
    <div>
        <asp:GridView ID="dgvMedi" runat="server" AutoGenerateColumns="false" DataKeyNames="Medicine_ID">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Medicine" ItemStyle-Width="150">
                    <ItemTemplate>
                        <asp:TextBox ID="txtMediDesc" runat="server" Text='<%# Eval("Medicine") %>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
             </Columns>
        </asp:GridView>
