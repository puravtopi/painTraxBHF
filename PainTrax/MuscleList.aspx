<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/site.master" CodeFile="MuscleList.aspx.cs" Inherits="Procedures" %>
    ...
    <div class="main-content-inner">
        <div class="page-content">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="gvMedicationTbl" runat="server" AutoGenerateColumns="false" PageSize="25" CssClass="table table-striped table-bordered table-hover" DataKeyNames="MuscleID" AllowPaging="True" OnPageIndexChanging="gvPatientDetails_PageIndexChanging1" PagerStyle-CssClass="pager">
                        <Columns>
                            <asp:BoundField DataField="MuscleID" HeaderText="Medication" />
                    ...
                    <asp:Panel ID="pnlAddEdit" runat="server" CssClass="modalPopup" Style="display: none; height: auto;">
                        <br />
                        <center>
                        <span style="font-weight:bold"> Add/Edit Muscle</span>
                        </center>
                        <br />
                        ...
                        <br />
                        <label class="control-label">Muscle</label>
                        <asp:TextBox ID="txtMuscle" Style="width: 80%;" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMuscle" Display="Dynamic" ErrorMessage="Please enter Muscle" SetFocusOnError="True" ValidationGroup="save"></asp:RequiredFieldValidator>
