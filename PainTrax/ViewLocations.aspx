<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="ViewLocations.aspx.cs" Inherits="ViewLocations" %>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:Button runat="server" ID="btnAdd" Text="Add New" CssClass="btn btn-primary" PostBackUrl="~/AddLocations.aspx" />
                        ...
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <asp:GridView ID="gvPatientDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover" PagerStyle-CssClass="pager">
                                    <Columns>
                                        <asp:BoundField DataField="NameOfPractice" HeaderText="Name Of Practice" />
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:HyperLink runat="server" CssClass="btn btn-link" ID="hlEdit" Target="_blank" NavigateUrl='<%# "~/AddLocations.aspx?id="+Eval("Location_ID") %>' Text="Edit"></asp:HyperLink>
                                                <asp:LinkButton runat="server" ID="lnkDelete" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?')" CausesValidation="false" OnClick="lnkDelete_Click" CommandArgument='<%# Eval("Location_ID") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
